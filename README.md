...
```javascript
dnansumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnansumors@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnansumors@umd/bundle.js"></script>
```
