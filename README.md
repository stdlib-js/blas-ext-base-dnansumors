...
```javascript
dnansumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnansumors@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dnansumors/tags). For example,

```javascript
dnansumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnansumors@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnansumors = require( 'path/to/vendor/umd/blas-ext-base-dnansumors/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnansumors@umd/browser.js"></script>
```
...
var v = dnansumors.ndarray( N, x, 1, 0 );
// returns 1.0
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-dnansumors.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-dnansumors

[test-image]: https://github.com/stdlib-js/blas-ext-base-dnansumors/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-dnansumors/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-dnansumors/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-dnansumors?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-dnansumors.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-dnansumors/main
...
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dnansumors/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dnansumors/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dnansumors/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dnansumors/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dnansumors/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dnansumors/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-dnansumors/main/LICENSE
